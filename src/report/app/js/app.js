...
var yaml_type_map = [
    ['!silvertine.ReportInfo', Dummy],
    ['!silvertine.ReportIndexEntry', ReportIndexEntry],
    ['!pf.Event', Dummy],
    ['!pf.MomentTensor', Dummy],
    ['!silvertine.ParameterStats', Dummy],
    ['!silvertine.TargetBalancingAnalyserResult', Dummy],
    ['!silvertine.NoiseAnalyserResult', Dummy],
    ['!silvertine.ResultStats', Dummy],
    ['!silvertine.MisfitConfig', Dummy],
    ['!silvertine.WaveformMisfitTarget', Dummy],
    ['!silvertine.WaveformMisfitConfig', Dummy],
    ['!silvertine.WaveformTargetGroup', Dummy],
    ['!silvertine.GNSSCampaignMisfitTarget', Dummy],
    ['!silvertine.GNSSCampaignMisfitConfig', Dummy],
    ['!silvertine.GNSSCampaignTargetGroup', Dummy],
    ['!silvertine.SatelliteMisfitTarget', Dummy],
    ['!silvertine.SatelliteMisfitConfig', Dummy],
    ['!silvertine.SatelliteTargetGroup', Dummy],
    ['!silvertine.PhaseRatioTarget', Dummy],
    ['!silvertine.PhaseRatioTargetGroup', Dummy],
    ['!silvertine.FeatureMeasure', Dummy],
    ['!silvertine.CMTProblem', Dummy],
    ['!silvertine.RectangularProblem', Dummy],
    ['!silvertine.VolumePointProblem', Dummy],
    ['!silvertine.VLVDProblem', Dummy],
    ['!pf.MTSource', Dummy],
    ['!pf.RectangularSource', Dummy],
    ['!pf.ExplosionSource', Dummy],
    ['!pf.VLVDSource', Dummy],
    ['!pf.HalfSinusoidSTF', Dummy],
    ['!silvertine.PlotCollection', Dummy],
    ['!silvertine.PlotGroup', Dummy],
    ['!silvertine.PlotItem', Dummy],
    ['!silvertine.PNG', Dummy],
...
angular.module('reportApp', ['ngRoute', 'ngSanitize'])
    ...
    .factory('ReportList', function(YamlMultiDoc) {
		...
		funcs.get_silvertine_versions = function() {
			var versions = new Set();

			for (var i=0; i<report_entries.length; i++) {
				var version = report_entries[i].silvertine_version;
    ...
    .factory('Info', function(YamlDoc) {
        ...
        funcs.get_version = function() {
            if (info) {
                return info.version_info.silvertine_version;
            } else {
                return '?';
            }
        };
    ...
    .controller('InfoController', function($scope, Info, ReportList) {
		...
		$scope.get_report_silvertine_versions = ReportList.get_silvertine_versions;
