import logging
from silvertine.environment import Environment, silvertineEnvironmentError
from silvertine.plot.collection import PlotCollectionManager
from silvertine.plot.config import PlotConfigCollection

logger = logging.getLogger('silvertine.plots')
...
def make_plots(
    ...
    #    try:
    #        plot.make(env)
    #    except (silvertineEnvironmentError, silvertineError) as e:
