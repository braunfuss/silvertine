...
logger = logging.getLogger('Silvertine_locator.plot')
...
def show_data(model, n=9, nskip=0, shuffle=False):
    ...
    :param model `Silvertine.model.Model` instance:
    ...
    save_figure(fig_labels, 'Silvertine_labels')
    save_figure(fig, 'Silvertine_features')
    save_figure(fig_w, 'Silvertine_waves')
